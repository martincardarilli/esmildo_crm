      ...
      <ul className="flex gap-x-2">
        {isAuthenticated ? (
          <>
            ...
            <li className="navbarOption">
              <ButtonLink to="/customers"> <CsLineIcons icon="web" />Mapa</ButtonLink>
            </li>
            <li className="navbarOption">
              <ButtonLink to="/completed-tasks"> <CsLineIcons icon="home-garage" />Loteo '7 </ButtonLink>
            </li>
           {/* <li className="navbarOption">
              <ButtonLink to="/asana"> <CsLineIcons icon="eye" />Asana (beta)</ButtonLink>
          </li> */}
            <li className="navbarOption">
              <ButtonLink to="/asana"> <CsLineIcons icon="user" />Personas</ButtonLink>
            </li>
